<header>
    ...
    <div class="header-sticky d-none d-lg-block d-xl-block" style="background-color: black">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="hb-menu">
                        <nav>
                            <ul>
                                <li class="dropdown-holder"><a href="{{route('home')}}" style="color: white;">Home</a>
                                </li>
                                <li class="megamenu-holder"><a href="#" style="color: white;">Danh mục</a>
                                    <ul class="megamenu hb-megamenu">
                                        <li><a href="shop-left-sidebar.html" style="color: black;">Nhà sản xuất</a>
                                            <ul>
                                        ...
                                        <li><a href="single-product-gallery-left.html" style="color: black;">Danh mục</a>
                                            <ul>
                                ...
                                <li><a href="{{route('info')}}" style="color: white;">Giới thiệu</a></li>
                                <li><a href="{{route('contact')}}" style="color: white;">Liên hệ</a></li>
                            </ul>
                        </nav>
                    </div>
